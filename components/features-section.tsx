...
export function FeaturesSection() {
  ...
  return (
    <section className="py-24 bg-[url('/images/transform.png')] text-green-500 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `
            linear-gradient(rgba(73, 230, 188, 0.1) 1px, transparent 1px),
            linear-gradient(90deg, rgba(73, 230, 188, 0.1) 1px, transparent 1px)
          `,
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              <Card className="bg-gray-900/50 border-gray-800 hover:bg-green-900/70 transition-all duration-300 overflow-hidden relative group">
                {/* Animated border */}
                <motion.div
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <feature.icon className="w-8 h-8 text-green-700 relative z-10" />
                    </div>

                    <motion.h3
                      className="text-2xl font-bold text-green-500 mb-3"
