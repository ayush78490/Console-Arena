...
export function GamesGrid() {
  ...
  return (
    <div className="flex-1 p-8">
      <div className="flex flex-col bg-gradient-to-br from-[#1f1f1f] to-[#2b2b2b] md:flex-row justify-between items-start md:items-center mb-8 gap-6">
        <div>
          <h1 className="text-4xl font-extrabold text-green-500 mb-1 ml-5">Games Library</h1>
          <p className="text-green-300 text-sm ml-5">Discover and play hardcore games</p>
        </div>
        {user && (
            ...
            >
              <Card className="bg-[#1f1f1f] border border-[#333] hover:border-[#555] transition-all duration-300 rounded-2xl overflow-hidden">
                ...
                <CardContent className="p-5 flex flex-col justify-between h-[220px]">
                  <div>
                    <h3 className="text-xl font-bold text-green-400 font-pixel mb-1 truncate">{game.title}</h3>
                    <p className="text-green-300 font-pixel text-sm line-clamp-2 mb-4">{game.description}</p>
                    {game.category && (
                      <span className="inline-block font-pixel bg-green-900/50 text-blue-300 text-xs px-2 py-1 rounded">
                        {game.category}
                      </span>
                    )}
                  </div>
                  <Button
                    ...
                    className="w-full font-pixel bg-green-600 hover:bg-green-700 text-green-100 text-sm rounded-full mt-2"
